 ...
 * /home/administrator/ros/amtec/msg/AmtecState.msg */
...
namespace amtec {
template <class ContainerAllocator> struct AmtecState_ {
  typedef AmtecState_<ContainerAllocator> Type;

  AmtecState_() : header(), state(0), position(0.0), velocity(0.0) {}

  AmtecState_(const ContainerAllocator &_alloc)
      : header(_alloc), state(0), position(0.0), velocity(0.0) {}
  ...
  typedef boost::shared_ptr<amtec::AmtecState_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream &operator<<(std::ostream &s,
                         const ::amtec::AmtecState_<ContainerAllocator> &v) {
  ros::message_operations::Printer<
      ::amtec::AmtecState_<ContainerAllocator> >::stream(s, "", v);
  return s;
}
...
struct IsMessage<amtec::AmtecState_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
struct IsMessage<amtec::AmtecState_<ContainerAllocator> const>
    : public TrueType {};
template <class ContainerAllocator>
struct MD5Sum<amtec::AmtecState_<ContainerAllocator> > {
  static const char *value() { return "19ace19cde5aea661ada2f628e7afeab"; }

  static const char *value(const ::amtec::AmtecState_<ContainerAllocator> &) {
    return value();
  }
...
struct DataType<amtec::AmtecState_<ContainerAllocator> > {
  static const char *value() { return "amtec/AmtecState"; }
...
template <class ContainerAllocator>
struct HasHeader<amtec::AmtecState_<ContainerAllocator> > : public TrueType {};
template <class ContainerAllocator>
struct HasHeader<const ::amtec::AmtecState_<ContainerAllocator> >
    : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template <class ContainerAllocator>
struct Serializer<amtec::AmtecState_<ContainerAllocator> > {
