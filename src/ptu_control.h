...
#define DEFAULT_ENABLE_ENV_SCAN true
...
lookup_table angle_increments_deg[N_DELTA_DEG] = {
    {0, 0},     {0.1, 1}, {0.2, 1.5}, {0.3, 2}, {0.4, 2.5}, {0.5, 3},
    {0.6, 3.5}, {0.7, 4}, {0.8, 6},   {0.9, 7}, {1.0, 8}};

void retrieveLaunchParameters(ros::NodeHandle);

double interp(lookup_table *, double, int);

void performSceneScan(ros::Publisher, double, double, ros::ServiceClient,
                      ros::ServiceClient);
void performGasScan(ros::Publisher, double, double, double, double, int, int,
                    double, ros::ServiceClient, ros::ServiceClient);
